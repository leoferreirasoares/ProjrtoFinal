  ...
  <main class="container-fluid px-0 g-pt-65">
    <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
      ...
      <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
        <div class="g-pa-20">
            <h1 class="g-font-weight-600 g-font-size-28 g-color-black g-mb-28">Cadastro Cliente</h1>
            <div class="row">
                <div class="col-xl-12">
                    <div class="js-custom-scroll g-height-500 g-pa-15 g-pa-0-30-25--md">
                        <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30" id="formCliente">
                            <div class="row">
                                <input type="hidden" name="metodo" value="cadCliente">
                                <div class="col-md-6 col-sm-12">    
                                    <div class="form-group g-mb-25">
                                        <label class="col-form-label" for="nome">Nome</label>
                                        <input class="form-control obrigatorio" name="nome" type="text">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">    
                                    <div class="form-group g-mb-25">
                                        <label class="col-form-label" for="telefone">Telefone</label>
                                        <input class="form-control obrigatorio" name="telefone" type="text">
                                    </div>
                                </div>
                            </div>                           
                            <button type="button" class="btn btn-md u-btn-primary rounded-0" onclick="validaObrigatorios('formCliente')">Cadastrar</button>
                        </form>
                    </div>
                </div>
            </div>
