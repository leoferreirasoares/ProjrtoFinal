    ...
    <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
      ...
      <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
        <div class="g-pb-50">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="js-custom-scroll g-height-600 g-pa-15 g-pa-0-30-25--md">
                        <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30" id="formAgendamento">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="g-mb-30 col-md-6 col-sm-12">                                   
                                     <label class="g-mb-10">Serviço</label>
                                     <select class="custom-select mb-3 obrigatorio" id="servicos" name="idservico">
                                    </select>
                                </div>
                                <div class="g-mb-30 col-md-6 col-sm-12">
                                    <label class="g-mb-10">Cliente</label>
                                    <select class="custom-select mb-3 obrigatorio" id="clientes" name="idCliente">
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="g-mb-30 col-sm-12">                                   
                                    <label class="g-mb-10" for="horaInicio">Horários</label>
                                    <select class="custom-select mb-3 obrigatorio" id="horaInicio" name="idHorario">
                                    </select>
                                </div>
                                
                            </div>
                                <button type="button" class="btn btn-md u-btn-primary rounded-0" onclick="validaObrigatorios('formAgendamento')">Agendar</button>
  ...
  <script>
    $(document).on('ready', function () {      
      ...
      $.HSCore.components.HSCountQty.init('.js-quantity');
       $.HSCore.components.HSDatepicker.init('#dataAgendamento');
